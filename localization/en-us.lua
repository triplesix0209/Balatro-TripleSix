        ...
        Joker = {
            ...
            j_666_canio_madness = {
                ...
                text = {
                    ...
                    "When a {C:attention}Joker{} card is destroyed, permanently add {C:attention}its sell value{} to this card's {X:mult,C:white}X{} Mult.",
            ...
            j_666_multiplying = {
                ...
                text = {
                    ...
                    "of rightmost {C:attention}Joker{} (except {C:attention}Multiplying Joker{}).",
                    "{C:inactive}(Currently #5#/#4# rounds)",
                    "Copies ability of {C:attention}Joker{} to the left and triggers it."
                }
            },
            j_666_murphy_law = {
                name = "Murphy's Law",
