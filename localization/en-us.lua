	...
	["descriptions"] = {
		["Joker"] = {
			...
			["j_666_diamond_bard"] = {
				...
				["text"] = {
                    ...
                    "{C:money}$#3#{}, as well as {C:mult}+#4#{} Mult for every ",
                    "{C:money}$#5#{} you have when scored",
				},
			},
			["j_666_heart_paladin"] = {
				["name"] = "Heart Paladin",
				["text"] = {
                    ...
                    "{C:green}#4# in #5#{} chance to re-trigger",
				},
			},
			["j_666_spade_archer"] = {
				["name"] = "Spade Archer",
				["text"] = {
                    ...
                    "{C:chips}+#3#{} Chips when scored. Gains {C:chips}+#4#{} ",
			...
			["j_666_collectible_chaos_card"] = {
				...
				["text"] = {
                    "{C:purple}(#1# + #2#){}",
                    "{C:mult}+#3#{} Mult per {C:attention}reroll{} in the shop.",
                    "{C:attention}#4#{} free {C:green}Reroll{} per shop",
                    "{C:inactive}(Currently {C:mult}+#5#{C:inactive} Mult)",
				},
			},
			...
			["j_666_capitalist_taurus"] = {
				...
				["text"] = {
                    "{C:purple}(#1# + #2#){}",
                    "{C:chips}+#3#{} Chips for each {C:money}$1{} you have.",
                    "{C:mult}+#4#{} Mult for every {C:money}$#5#{} you have.",
                    "{C:inactive}(Currently {C:chips}+#6#{C:inactive} Chips, {C:mult}+#7#{C:inactive} Mult)",
				},
			},
			...
			["j_666_perkeo_sobriety"] = {
				...
				["text"] = {
                    ...
                    "Creates {C:attention}2{} {C:dark_edition}Negative{} copies of random {C:attention}consumable{} cards",
			...
			["j_666_canio_madness"] = {
				...
				["text"] = {
                    ...
                    "When a {C:attention}Joker{} card is destroyed, permanently add {C:attention}0.5 its sell value{} to this card's {X:mult,C:white}X{} Mult.",
                    "{C:inactive}(Currently {X:mult,C:white}X#4#{C:inactive} Mult)",
				},
			},
			["j_666_yorick_skull"] = {
		...
		["Other"] = {
			...
			["chicot_bl_house"] = {
				["name"] = "The House",
				["text"] = {
					"{C:attention}First hand{} this round",
			...
			["chicot_bl_club"] = {
				["name"] = "The Club",
				["text"] = {
					"Retrigger all played {C:clubs}Club{} cards"
				},
			},
			["chicot_bl_fish"] = {
				["name"] = "The Fish",
			...
			["chicot_bl_goad"] = {
				["name"] = "The Goad",
				["text"] = {
					"Retrigger all played {C:spades}Spade{} cards"
				},
			},
			["chicot_bl_water"] = {
				["name"] = "The Water",
			...
			["chicot_bl_mouth"] = {
				["name"] = "The Mouth",
				["text"] = {
					"Retrigger the {C:attention}first hand{}"
				},
			},
			["chicot_bl_plant"] = {
				["name"] = "The Plant",
			...
			["chicot_bl_serpent"] = {
				["name"] = "The Serpent",
				["text"] = {
					"Draw to {C:attention}full{} hand size",
			...
			["chicot_bl_head"] = {
				["name"] = "The Head",
				["text"] = {
					"Retrigger all played {C:hearts}Heart{} cards"
				},
			},
			["chicot_bl_tooth"] = {
				["name"] = "The Tooth",
			...
			["chicot_bl_flint"] = {
				...
				["text"] = {
					...
					"of played {C:attention}poker hands{}"
				},
			},
			["chicot_bl_mark"] = {
				["name"] = "The Mark",
				["text"] = {
					"{C:attention}face{} cards give {X:mult,C:white}X2{} Mult"
				},
			},
			["chicot_bl_acorn"] = {
				["name"] = "Amber Acorn",
				["text"] = {
					"{C:mult}+10{} Mult for each {C:attention}Joker{}"
				},
			},
			["chicot_bl_leaf"] = {
				["name"] = "Verdant Leaf",
				["text"] = {
					"Selling a {C:attention}Joker{} creates a",
					"random {C:attention}Joker{} {C:inactive}(1 per round){}"
				},
			},
			["chicot_bl_vessel"] = {
				["name"] = "Violet Vessel",
			...
			["chicot_bl_heart"] = {
				...
				["text"] = {
					...
					"{C:attention}Joker{} is granted {X:mult,C:white}X5{} Mult",
					"this round"
				},
			},
			["chicot_bl_bell"] = {
