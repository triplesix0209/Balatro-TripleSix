...
function init_localization()
	local abc = assert(load(nativefs.read(talisman_path .. "/localization/talisman.lua")))()
...
local config_read_result = nativefs.read(talisman_path.."/talisman_config.lua")
...
Talisman.config_tab = function()
                ...
                callback = function(_set_toggle)
	                nativefs.write(talisman_path .. "/talisman_config.lua", STR_PACK(Talisman.config_file))
                end}),
                create_option_cycle({
                ...
                return {
                    {n = G.UIT.C, config = {align = "cm", padding = 0.1}, nodes = tal_nodes}
                }
              end
